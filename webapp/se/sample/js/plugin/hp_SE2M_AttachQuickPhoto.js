...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
    ...
    makePopupURL : function(){
        var sPopupUrl = "/readingbetter/se/sample/photo_uploader/photo_uploader.html";
        return sPopupUrl;
    },
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img src="http://ec2-52-34-170-68.us-west-2.compute.amazonaws.com/{=sOriginalImageURL}" title="{=sName}" >';
